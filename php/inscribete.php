    ...
    <div id="div_cuotas_actividades" hidden>
        ...
        <ul>
                ...
                <select id="cuota" name="cuota">
                    ...
                    if ($resultado_cuotas) {
                        while ($fila = mysql_fetch_array($resultado_cuotas)) {
                            echo '<option value="' . $fila['id_cuota'] . '" title="' . $fila['descripcion'] . '" onmouseover="cambiar_actividades_cuota(' . $fila['id_cuota'] . ');">'
            ...
            <li>
                ...
                <ul class="inscripcion_checkbox" id="actividades_por_cuotas">
                    <?php
            ...
            <li>
                ...
                <button type="button" class="submit secundario" onclick="activar_paso3()">Siguiente</button>
            </li>
        </ul>
    </div>
